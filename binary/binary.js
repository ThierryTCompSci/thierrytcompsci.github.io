$(document).ready ( function () {
	...
	$( "#card1" ).click(function() {
		var src = ($(this).attr('src') === 'card_back.png')? 'card1.png': 'card_back.png';
		$(this).attr('src', src);
		var text1 = ($("#b1").text() === '0')? '1': '0';
		$("#b1").text(text1);
		calculateDecimal();
	...
	$( "#card2" ).click(function() {
		var src = ($(this).attr('src') === 'card_back.png')? 'card2.png': 'card_back.png';
		$(this).attr('src', src);
		var text1 = ($("#b2").text() === '0')? '1': '0';
		$("#b2").text(text1);
		calculateDecimal();
	...
	$( "#card3" ).click(function() {
		var src = ($(this).attr('src') === 'card_back.png')? 'card4.png': 'card_back.png';
		$(this).attr('src', src);
		var text1 = ($("#b3").text() === '0')? '1': '0';
		$("#b3").text(text1);
		calculateDecimal();
	...
	$( "#card4" ).click(function() {
		var src = ($(this).attr('src') === 'card_back.png')? 'card8.png': 'card_back.png';
		$(this).attr('src', src);
		var text1 = ($("#b4").text() === '0')? '1': '0';
		$("#b4").text(text1);
		calculateDecimal();
